    ...
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          ...
          <strong>authorization</strong> are essential concepts for managing
          user access and securing resources. Although they are often used
          together, they serve distinct purposes:
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Authorization</strong>: Determines what an authenticated
            user is allowed to do. It answers the question, &quot;What can you
            do?&quot;
          </li>
        </ul>
        <p>
          In this guide, we will explore the concepts of authentication and
          authorization, the various methods and strategies for implementing
          them, and best practices to secure your applications.
        </p>
        <hr />
        <h3>What is Authentication?</h3>
        <p>
          <strong>Authentication</strong> is the process of verifying that
          someone is who they claim to be. It ensures that users can access the
        ...
        <p>
          ...
          is allowed to do within an application. It controls access to
          resources based on roles, permissions, or attributes. For example:
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Action-Based Permissions</strong>: Controlling what actions
            a user can perform, such as reading, writing, or deleting a
            resource.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <strong>Cons</strong>: Vulnerable to brute-force attacks and
            phishing if not properly secured.
          </li>
        </ul>
        <h4>
        ...
        <ul>
          <li>
            <strong>Description</strong>: Users authenticate with credentials
            and receive a token, often a JWT (JSON Web Token), which is used for
            subsequent requests.
          </li>
          <li>
            <strong>Pros</strong>: Stateless, scalable, and allows Single
            Sign-On (SSO).
          </li>
          <li>
        ...
        <ul>
          <li>
            <strong>Description</strong>: OAuth2 is an authorization protocol
            that allows third-party applications to access user resources.
            OpenID Connect extends OAuth2 to provide authentication.
          </li>
          <li>
...
`}
        ...
        />
        <p>
          This example uses bcrypt to hash passwords securely before storing
          them.
        </p>
...
`}
        ...
        />
        <p>
          This middleware checks if a user’s role has the permission to perform
          a specific action.
        </p>
        <h3>Using OAuth2 and OpenID Connect</h3>
        <p>
          OAuth2 allows users to grant third-party applications access to their
          resources without sharing credentials. OpenID Connect is built on top
          of OAuth2 for authentication.
        </p>
        <h4>Example Flow:</h4>
        <ol>
          ...
          <li>
            Upon granting access, Google sends an authorization code back to
            your server.
          </li>
          <li>
            Your server exchanges the code for an access token and, optionally,
            an ID token (for user information).
          </li>
        </ol>
        <p>
...
`}
        ...
        <ol>
          <li>
            <strong>Hash Passwords</strong>: Always hash passwords using a
            strong hashing algorithm like bcrypt before storing them.
          </li>
          <li>
          ...
          <li>
            <strong>Secure JWTs</strong>: Use strong secrets for signing JWTs
            and keep them short-lived to minimize risks.
          </li>
          <li>
        ...
        <p>
          ...
          RBAC, you can build robust and secure APIs that safeguard sensitive
          data and maintain user privacy.
        </p>
        <p>
          Mastering these techniques will empower you to build scalable and
          secure applications, ensuring a better experience for your users.
        </p>
      </div>
    </ModuleWrapper>
  );
