...
export default function DB() {
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        In the previous module, we were introduced to REST APIs. The problem we
        now have is if we try to add, delete or update data, the data isn&apos;t
        persisted. What we need to alleviate this is to integrate a database to
        our apps. For this example, we will introduce MondoDB as our database
      ...
      <p>
        ...
        <strong>Mongoose</strong>, a powerful ODM (Object Data Modeling) library
      ...
      <ol>
        <li>
          <p>
            ...
            <strong>&quot;Sign In&quot;</strong> if you already have an account.
          </p>
        </li>
        <li>
          <p>
      ...
      <ol>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              Choose a <strong>Cloud Provider</strong> (e.g., AWS, Google Cloud,
              or Azure) and a <strong>Region</strong> close to your users for
              better latency.
            </li>
            <li>
            ...
            <li>
              Click <strong>&quot;Create Cluster&quot;</strong>. It might take a
              few minutes for the cluster to be set up.
            </li>
          </ul>
        </li>
      </ol>
        ...
        <li>
          ...
          <ul>
            <li>
              ...
              <strong>&quot;Database Access&quot;</strong> on the left sidebar.
            </li>
            <li>
            ...
            <li>
              ...
              Make sure to save these credentials as you’ll need them to connect
              later.
            </li>
            <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              anywhere (for development purposes) or specify your IP address for
              better security.
            </li>
            <li>
      ...
      <ol>
        <li>
          ...
          <ul>
            ...
            <li>
              Copy the <strong>connection string</strong> provided. It will look
              something like this:
            </li>
          </ul>
        </li>
...
`}
        ...
        <li>
          <p>
            <strong>Create a basic Express server</strong>: Create a file named{" "}
            <code>server.js</code>:
          </p>
          <CodeHighlight
            content={`
...
`}
          ...
          <p>
            ...
            . You should see the message &quot;Welcome to the Express MongoDB
            App!&quot;.
          </p>
        </li>
      </ol>
...
`}
      ...
      <ol>
        <li>
          <p>
            <strong>Set up a MongoDB connection</strong> using Mongoose. Create
            a new file named <code>config/mongodb.js</code>:
          </p>
          <CodeHighlight
            content={`
...
`}
          ...
          />
          <p>
            This schema defines a <code>User</code> model with <code>name</code>
            , <code>email</code>, and <code>age</code> fields.
          </p>
        </li>
      </ol>
      <hr />
...
`}
        ...
        <li>
          <p>
            <strong>Validation</strong>: Use Mongoose validation to ensure that
            data is consistent and meets your application&#39;s requirements.
          </p>
        </li>
        <li>
          <p>
            <strong>Error Handling</strong>: Implement proper error handling to
            make debugging easier and to improve the user experience.
          </p>
        </li>
      </ol>
      <hr />
      ...
      <p>
        ...
        connected to MongoDB using Mongoose. You learned how to define schemas,
        create models, and build API routes for CRUD operations.
      </p>
    </div>
  );
}
