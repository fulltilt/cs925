  ...
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        ...
        scalable server-side applications. It simplifies the process of building
        RESTful APIs, managing routes, handling requests and responses, and
        integrating middleware. Express is known for its simplicity, making it a
      ...
      <p>
        ...
        up a simple server, define routes, handle middleware, and create RESTful
        APIs.
      </p>
      <hr />
      ...
      <ul>
        <li>
          <strong>Minimalistic</strong>: Express doesn&apos;t dictate a specific
          project structure, giving developers flexibility in how they organize
          their code.
        </li>
        <li>
...
`}
      ...
      <p>
        ...
        <code>http://localhost:3000</code> in your browser, and you&apos;ll see
        the text &quot;Hello, World!&quot;.
      </p>
      <h2>Handling Routes</h2>
      <p>
        Express allows you to define routes for different HTTP methods (GET,
        POST, PUT, DELETE) using <code>app.get()</code>, <code>app.post()</code>
        , <code>app.put()</code>, and <code>app.delete()</code>.
      </p>
      <CodeHighlight
        content={`
// Define a GET route
...
`}
      ...
      />
      <p>
        In this example, accessing <code>http://localhost:3000/users/123</code>{" "}
        would display &quot;User ID is: 123&quot;.
      </p>
...
`}
      ...
      <p>Let&#39;s build a simple RESTful API for managing a list of books:</p>
      <CodeHighlight
        content={`
let books = [
...
`}
      ...
      <p>
        ...
        quickly and easily. By mastering the basics of routing, middleware, and
        error handling, you can build scalable and efficient web applications.
      </p>
    </div>
  );
}
