...
export default function NodeIntro() {
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        Welcome to the <strong>Node.js</strong> introductory course! Node.js is
        a powerful JavaScript runtime that allows you to build server-side
      ...
      <p>
        ...
        on <strong>Google Chrome&#39;s V8 JavaScript engine</strong>. It allows
        you to run JavaScript code outside of a web browser, making it ideal for
      ...
      <ul>
        ...
        <li>
          Download the <strong>LTS version</strong> (Long Term Support) for your
      ...
      <p>
        After installation, open your terminal and run the following commands to
...
`}
      ...
      <p>
        Inside the <code>my-website</code> folder, run the following command to
        create a <code>package.json</code> file, which stores metadata about
        your project:
      </p>
      <CodeHighlight
        content={`
...
`}
      ...
      <p>
        Node.js allows you to create a simple HTTP server with just a few lines
        of code. Let’s create a basic server that responds with &quot;Hello,
        World!&quot; when accessed in a browser.
      </p>
      <h3>
...
`}
      ...
      <p>
        Replace the content of <code>server.js</code> with the following code (a
        lot of the code in the <code>http.createServer</code> function will look
        pretty crazy if you're new to Node so just ignore it for now. Basically
        what it's doing is creating a server and taking in a callback function
        that is called whenever a request is made. If it's successful, return
        the contents of index.html else return an error):
      </p>
      <CodeHighlight
        content={`
const http = require('http');
...
`}
      ...
      <p>
        Replace the content of <code>server.js</code> with this (notice how the
        code looks a lot less crazy than what we had before yet it still does
        the same thing):
      </p>
      <CodeHighlight
        content={`
...
`}
      ...
      <ul>
        ...
        <li>
          Explore the <strong>index.html</strong> file to modify the content and
