    ...
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <ul>
        <li>
          ...
          the information needed to process the request, without relying on the
          server’s previous interactions.
        </li>
        <li>
        ...
        <li>
          ...
          it is connected directly to the server or through intermediate layers.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Resources</strong> are the key elements in RESTful APIs, like
          users, orders, or products.
        </li>
        <li>
          Each resource is identified by a <strong>URL</strong>. For example, a
          user resource might be accessed at{" "}
      ...
      <ul>
        ...
        <li>
          This simplifies the server and makes it easier to scale, as the server
          doesn’t need to maintain sessions.
        </li>
      </ul>
      <h3>
      ...
      <ul>
        <li>
          RESTful APIs use a uniform and predictable interface, making it easier
          for developers to understand how to interact with different resources.
        </li>
      </ul>
      <h2>HTTP Methods and CRUD Operations</h2>
      <p>
        RESTful APIs use HTTP methods to perform actions on resources. Each HTTP
        method maps to a CRUD (Create, Read, Update, Delete) operation:
      </p>
      <ul>
        <li>
      ...
      <ul>
        <li>
          ...
          use <code>/users</code> for a collection of user resources rather than{" "}
          <code>/getUsers</code> or <code>/createUser</code>.
        </li>
      </ul>
      <h3>
      ...
      <ul>
        <li>
          Use plural nouns for collections. For example, <code>/users</code> for
          multiple users and <code>/users/1</code> for a specific user.
        </li>
      </ul>
      <h3>
      ...
      <ul>
        <li>
          The action is defined by the HTTP method, so avoid using verbs in the
          URL like <code>/createUser</code> or <code>/deleteUser</code>.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li>
              <code>GET /products?category=electronics&amp;sort=price</code> to
      ...
      <ul>
        ...
        <li>
          <strong>201 Created</strong>: A new resource was created successfully.
        </li>
        <li>
...
`}
      ...
      <ul>
        ...
        <li>
          <strong>Header Versioning</strong>: Specify the version in the request
          header: <code>Accept: application/vnd.example.v1+json</code>.
        </li>
      </ul>
      <p>
      ...
      <ul>
        <li>
          ...
          <strong>JWT (JSON Web Tokens)</strong> or OAuth to verify the identity
          of clients.
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>Use Consistent Naming Conventions</strong>: Keep your resource
          names consistent to avoid confusion.
        </li>
        <li>
          <strong>Use JSON as the Response Format</strong>: JSON is widely used
          and easy to work with in most programming languages.
        </li>
        <li>
          <strong>Document Your API</strong>: Use tools like{" "}
          <strong>Swagger</strong> or <strong>Postman</strong> to document your
          API and provide clear examples for users.
        </li>
        <li>
