...
export default function () {
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        Designing a database is a critical part of building a robust, efficient,
        and scalable software system. A well-designed database ensures that data
        is organized, stored, and retrieved efficiently, which directly affects
        the performance and maintainability of an application. This guide covers
        the fundamental principles of database design, focusing on relational
        databases, but many of the concepts also apply to NoSQL databases.
      </p>
      <hr />
      ...
      <ul>
        ...
        <li>
          <strong>Difficulty in maintaining</strong> the database as the system
          evolves.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          <code>user_id</code> in an orders table should refer to a valid user).
        </li>
      </ul>
      ...
      <ul>
        <li>Organize data to reduce redundancy and improve data integrity.</li>
        <li>
      ...
      <ul>
        ...
        <li>
          Plan for future growth by designing the schema to handle more data and
          users.
        </li>
      ...
      <ul>
        <li>
          ...
          such as <code>User</code>, <code>Order</code>, or <code>Product</code>
          .
        </li>
        <li>
      ...
      <ul>
        <li>
          A <strong>primary key</strong> is a unique identifier for each record
          in a table.
        </li>
        <li>
      ...
      <p>
        ...
        improve integrity. It involves breaking down tables and ensuring
      ...
      <ul>
        ...
        <li>
          Remove partial dependencies—every non-key column should depend on the
          whole primary key.
        </li>
        <li>
          Example: In an <code>Order</code> table with <code>order_id</code> and{" "}
          <code>product_name</code>, move <code>product_name</code> to a{" "}
      ...
      <ul>
        <li>
          <strong>Denormalization</strong> is the process of combining tables to
          reduce the number of joins in queries, improving read performance.
        </li>
        <li>
          It is used when performance is more critical than storage efficiency.
        </li>
        <li>
...
`}
      ...
      <ul>
        ...
        <li>
          <strong>Consider Data Security</strong>: Store sensitive data securely
          using encryption and follow the principle of least privilege for
          access control.
        </li>
      </ul>
      <hr />
