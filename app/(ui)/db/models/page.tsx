    ...
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          ...
          optimize performance. This tutorial will walk through what data
          modeling and normalization are, why they are important, and how to
          apply these concepts to create well-structured databases.
        </p>
        <hr />
        ...
        <ul>
          <li>
            <strong>Organizes Data</strong>: Ensures that data is structured in
          ...
          <li>
            <strong>Optimizes Queries</strong>: Enables efficient query design
            and improves database performance.
          </li>
          <li>
            <strong>Supports Scalability</strong>: Allows for easier
            modification and growth as application needs change.
          </li>
        </ul>
        <hr />
        <h2>Types of Data Models</h2>
        <p>
          Data modeling is typically broken down into three levels, each serving
          a different purpose:
        </p>
        ...
        <ul>
          ...
          <li>
            Example: A <code>Customer</code> entity with{" "}
            <code>customer_id</code> (primary key), <code>name</code>,{" "}
            <code>email</code>, etc.
          </li>
        </ul>
        ...
        <p>
          ...
          minimize redundancy and dependency. It involves dividing a database
          into smaller tables and defining relationships between them. The goal
          is to ensure data integrity and make databases more efficient to
          update.
        </p>
        <hr />
        ...
        <ul>
          ...
          <li>
            Each column should have a unique name, and each row should be
            unique.
          </li>
          <li>
            <p>Example:</p>
        ...
        <ul>
          ...
          <li>
            Remove transitive dependencies—non-key attributes should not depend
            on other non-key attributes.
          </li>
          <li>
            <p>
              Example: A table with <code>student_id</code>,{" "}
              <code>student_name</code>, and <code>department_name</code> might
              be split into <code>Students</code> and <code>Departments</code>.
            </p>
            <br />
            <p> Original table:</p>
            <Table>
        ...
        <ul>
          ...
          <li>
            <code>OrderDetails</code> Table: <code>order_id</code> (foreign
            key), <code>product_id</code> (foreign key), <code>quantity</code>
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>
            Ensure 2NF by storing <code>product_name</code> and{" "}
            <code>price</code> in the <code>Product</code> table, not{" "}
        ...
        <p>
          <strong>Denormalization</strong> involves combining tables to reduce
          the number of joins needed for queries. It can improve read
          performance at the cost of increased storage and potential data
          redundancy.
        </p>
        <ul>
          <li>
        ...
        <ul>
          <li>
            <strong>Start with a conceptual model</strong> to understand
            entities and relationships before diving into details.
          </li>
          <li>
          ...
          <li>
            <strong>Index columns</strong> that are frequently queried to
            improve performance.
          </li>
          <li>
        ...
        <p>
          ...
          design databases that ensure data consistency while avoiding
          unnecessary redundancy. With this tutorial, you should be equipped
          with the knowledge to create well-structured databases that serve the
