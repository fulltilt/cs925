  ...
  return (
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <ul>
          <li>
            <strong>Definition</strong>: Store data as documents, usually in
            JSON or BSON format. Each document contains key-value pairs and can
          ...
          <li>
            <strong>Use Case</strong>: Content management systems, user
            profiles, catalogs.
          </li>
          <li>
...
`}
        ...
        <ul>
          <li>
            <strong>Definition</strong>: Store data as key-value pairs, similar
            to a dictionary or hash map.
          </li>
          <li>
...
`}
        ...
        <ul>
          ...
          <li>
            <strong>Scalability is critical</strong>: Horizontal scaling is
            needed for large-scale applications with lots of users or data.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>Document</strong>: A record stored in a collection, usually
            in JSON format.
          </li>
        </ul>
...
`}
        ...
        <ul>
          ...
          <li>
            <strong>Flexible Data Models</strong>: Adaptable schema allows you
            to change the structure of your data without downtime.
          </li>
          <li>
        ...
        <ul>
          <li>
            <strong>Lack of Standardization</strong>: Each NoSQL database has
            its own query language and features.
          </li>
          <li>
          ...
          <li>
            ...
            relationships can be more complex than in relational databases
            (e.g., requiring manual management in document databases).
          </li>
        </ul>
        <hr />
        <h2>Conclusion</h2>
        <p>
          ...
          large-scale data, and real-time requirements. Whether you are building
          a social media platform, IoT application, or a content management
          system, understanding the strengths and weaknesses of NoSQL databases
          will help you choose the right tool for your project.
        </p>
        <p>
