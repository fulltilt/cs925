    ...
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          ...
          almost every type of software—from web applications to mobile apps,
          and even embedded systems. Understanding the basics of databases is
          crucial for developers to build scalable and data-driven applications.
          This tutorial will provide an introduction to databases, types of
          databases, and basic concepts like SQL, NoSQL, and database
          operations.
        </p>
        <hr />
        ...
        <p>
          ...
          stored and organized in a way that makes it easy to access, manage,
          and update. Think of it like a digital filing cabinet where data can
        ...
        <p>
          ...
          retrieving existing data, updating records, and deleting data that is
          no longer needed.
        </p>
        <hr />
        ...
        <ul>
          <li>
            <strong>Tables</strong> (SQL): In relational databases, data is
            stored in tables. Each table represents an entity (e.g.,
            &quot;Users&quot;, &quot;Products&quot;).
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>Documents</strong> (NoSQL): In document-based NoSQL
            databases, data is stored in documents. Each document can have a
            different structure but is often represented as JSON or BSON
            objects.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Primary Key</strong>: A unique identifier for each record in
            a table (e.g., <code>user_id</code>).
          </li>
          <li>
            <strong>Foreign Key</strong>: A field in one table that refers to
            the primary key of another table, establishing relationships between
            tables.
          </li>
          <li>
        ...
        <p>
          Most databases support the following basic operations, often referred
          to as <strong>CRUD</strong>:
        </p>
        <ul>
          <li>
            <strong>Create</strong>: Add new data to the database (e.g., adding
            a new user).
          </li>
          <li>
            <strong>Read</strong>: Retrieve existing data from the database
            (e.g., querying all products).
          </li>
          <li>
          ...
          <li>
            <strong>Delete</strong>: Remove data from the database (e.g.,
            deleting an outdated record).
          </li>
        </ul>
...
`}
        ...
        <ul>
          ...
          <li>
            <strong>PostgreSQL</strong>: A powerful, open-source SQL database
            that supports complex queries and transactions.
          </li>
          <li>
            <strong>MongoDB</strong>: A popular NoSQL database that stores data
        ...
        <p>
          ...
          NoSQL database like MongoDB, understanding the strengths and
          weaknesses of each can help you make better decisions for your
          projects. By mastering CRUD operations, database queries, and data
          models, you can design efficient and scalable applications that handle
          data effectively.
        </p>
      </div>
    </ModuleWrapper>
