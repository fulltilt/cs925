    ...
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          ...
          with databases, perform operations like creating tables, querying
          data, inserting records, updating entries, and deleting data. SQL is
          widely used in applications that need to store and retrieve structured
          data, such as e-commerce sites, financial systems, and inventory
          management systems.
        </p>
        <hr />
        <h2>What is SQL?</h2>
        <p>
          ...
          management system (RDBMS). It provides a way to define, manipulate,
          and query data. SQL is used for a variety of tasks, such as:
        </p>
        <ul>
        ...
        <p>
          A <strong>relational database</strong> organizes data into tables,
          which consist of rows (records) and columns (fields).
        </p>
        <hr />
...
`}
        ...
        <ul>
          ...
          <li>
            <strong>Column names</strong> and <strong>table names</strong>{" "}
            should match the exact case as they are defined in the database.
          </li>
        </ul>
        <hr />
...
`}
        ...
        <p>
          ...
          return a single value. Common aggregate functions include:
        </p>
        <ul>
          <li>
...
`}
          ...
          <li>
            <strong>MAX</strong> and <strong>MIN</strong>: Returns the maximum
            or minimum value.
            <CodeHighlight
              content={`
...
`}
        ...
        <p>
          The <code>GROUP BY</code> statement is used to group rows that have
          the same values into summary rows. The <code>HAVING</code> clause is
...
`}
        ...
        <h2>Conclusion</h2>
        <p>
          SQL is a powerful and versatile language for managing data in
          relational databases. By understanding the basic syntax and commands,
          you can perform a wide range of database operations, from creating
          tables to filtering and joining data. Whether you are managing a small
          website or a large-scale application, SQL is an essential tool for
          data management.
        </p>
        <p>
