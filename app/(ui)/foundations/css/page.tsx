    ...
    <div className="flex flex-col sm:flex-row justify-center h-full">
      ...
      >
        ...
        <p>
          ...
          elements on a web page. It allows you to add colors, fonts, layouts,
          and more, making your website look attractive and professional. Let’s
          go through a tutorial that covers the basics.
        </p>
        <h2>
...
h1 {
    ...
    font-size: 36px;
        ...
        <p>
          For best practices, it's advised not to do this but inline styles are
          used from time to time when dealing specifity issues which will be
          covered in depth in another module.
        </p>
        <h3>Example:</h3>
        <CodeHighlight
          content={`
...
font-size: 36px;
  ...
  `,
        ...
        <p>
          Selects elements with a specific class attribute. Class selectors use
          a period (<code>.</code>).
        </p>
        <h3>Example:</h3>
        <CodeHighlight
...
`,
        ...
        <p>
          ...
          borders, padding, and content. This will be covered in more depth in a
          future module.
        </p>
        <ul>
          <li>
...
`,
        ...
        <p>
          Flexbox is used for designing flexible layout structures. This will be
          covered in more depth in a future module .
        </p>
        <h3>Example:</h3>
        <CodeHighlight
          content={`
