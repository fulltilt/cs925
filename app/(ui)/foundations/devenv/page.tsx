    ...
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson ">
        ...
        <p>
          ...
          necessary tools, their installation, and how to configure your
          workspace for efficient coding. This is perfect for beginners starting
          out with web development or those who want to ensure their environment
          is optimized for productivity.
        </p>
        <p>
          ...
          you started or at the very least familiarized with tools that will
        ...
        <ul>
          ...
          <li>
            ...
            <ul className="ml-4">
              ...
              <li>
                <strong>Browser with DevTools</strong>: Helps debug and test
                your website.
              </li>
            </ul>
          </li>
        ...
        <p>
          <strong>Goal</strong>: Set up Visual Studio Code, a powerful code
        ...
        <ul>
          ...
          <li>
            <code>git commit -m &quot;message&quot;</code>: Commit changes with
            a message.
          </li>
          <li>
...
`}
        ...
        <p>
          <strong>Goal</strong>: Set up Node.js and npm for managing packages
          and building JavaScript applications.
        </p>
        <ul>
          <li>
...
`}
        ...
        <ul>
          <li>
            <strong>Google Chrome</strong> is commonly used because of its
            robust DevTools.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <ul className="ml-4">
              <li>
                Install the Prettier extension in VS Code. Once installed,
                enable formatting on save by going to VS Code settings (
                <code>Command + ,</code> on Mac or <code>Ctrl + ,</code> on
                Windows), searching for &apos;format&apos; in search bar and
                then checking <strong>Format on Save</strong>
              </li>
            </ul>
          </li>
          <li>
...
`}
        ...
        <h3>
          <strong>
            8. Optional/Advanced: Setting Up Docker for Containerized
            Development
          </strong>
        </h3>
        <p>
        ...
        <p>
          ...
          containerize your database and/or app to make life easier. For now,
          you don&apos;t have to worry about it but Docker will be a great
