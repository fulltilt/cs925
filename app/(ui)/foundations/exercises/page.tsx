    ...
    <ModuleWrapperClient>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          ...
          repetition and by building things. The first exercise we'll do is to
          use HTML and CSS (JavaScript we'll put off for now) to replicate
          landing pages of some websites.
        </p>
        <p>
          One example is the Visual Studio Code landing page but you can pick
          any landing page. The important thing is for you to start building and
          to get acquanted with setting up a development environment and to
        ...
        <p>
          ...
          save the image locally and link to it using an <code>img</code> tag.
          You will have to give the correct path to the image which will be an
          important thing to know how to do. You can view the{" "}
          <a href="/shell/paths">Paths module</a> for more information, namely
          on understanding relative paths.
        </p>
        <p>
          ...
          the styling. You can also view other web pages and try to replicate
          what they have. Feel free to skip over sites that have animation
          effects or videos as that's more advanced and studies have shown,
          aren't really necessary and can actually be detrimental to the user
          experience.
        </p>
        <p>
