...
`}
      ...
      <ul>
        ...
        <li>
          <code>border=&quot;1&quot;</code>: Adds a border around the table and
          cells.
        </li>
      </ul>
      <h2>
...
`}
      ...
      <p>
        Semantic HTML uses elements that clearly describe their meaning to both
...
`}
      ...
      <ul>
        ...
        <li>
          <strong>Attributes</strong> provide additional information to elements
          (e.g., <code>href</code>, <code>src</code>, <code>alt</code>).
        </li>
        <li>
