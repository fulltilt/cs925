      ...
      <div className="flex flex-col sm:flex-row justify-center h-full">
        ...
        >
          ...
          <p>
            ...
            creating web pages. It uses a system of tags and elements to
            structure content. Here’s a simple tutorial to help you understand
            the basics.
          </p>
...
`,
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              <code>&lt;html&gt;</code>: The root element that contains all
              other HTML elements.
            </li>
            <li>
...
`,
          ...
          />
          <p>
            Tags like <code>&lt;h2&gt;</code> and <code>&lt;p&gt;</code> are
            known as
            <em>block-level elements</em>, meaning they take up the full width
            of their container.
          </p>
          <h3>Common Tags:</h3>
          <ul>
            <li>
              <code>&lt;h1&gt;</code> to <code>&lt;h6&gt;</code>: Headings (H1
...
<img src="image.jpg" alt="A description of the image" width="500">`}
          ...
          <ul>
            ...
            <li>
              <code>alt</code>: Provides alternative text for screen readers or
...
`,
          ...
          <p>
            HTML can be styled using CSS (Cascading Style Sheets). You can
            either include CSS in the <code>&lt;head&gt;</code> section of the
            HTML or as an external file.
          </p>
...
`,
          ...
          <p>
            Here&apos;s a full example that includes different elements
            we&#39;ve discussed:
          </p>
          <CodeHighlight
            content={`
...
`,
          ...
          <ul>
            ...
            <li>
              Use <strong>semantic HTML</strong> for meaningful content
              structure.
            </li>
            <li>
          ...
          <p>
            That&#39;s the foundation of HTML! You can now start experimenting
            and building your own web pages but as you can tell, the pages look
            very bland so let&apos;s get into how we can add some styling to our
            pages.
          </p>
          {/* <NavigationLinks
          prevLesson={{
