  ...
  return (
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          JavaScript is one of the core programming languages of the web,
          enabling interactivity, dynamic content, and complex functionalities
          on websites. Unlike HTML and CSS, which focus on the structure and
          styling of web pages, JavaScript allows you to manipulate content,
          respond to user events, and connect to servers. This course will guide
          you through the basics of JavaScript, its syntax, key concepts, and
        ...
        <p>
          JavaScript is a <strong>programming language</strong> used primarily
          for creating dynamic and interactive content on websites. It is one of
          the core technologies of the web, alongside <strong>HTML</strong> (for
        ...
        <ul>
          ...
          <li>
            Build entire applications for both the web and mobile devices.
          </li>
        </ul>
        <p>
        ...
        <p>
          To start coding in JavaScript, you need a text editor and a web
          browser. As this is an introductory module, we can get away with doing
          everything in the browser console. Go to the{" "}
...
`}
          ...
          <li>
            ...
            open the Developer Tools. Go to the <strong>Console</strong> tab,
        ...
        <ul>
          <li>
            <code>let</code> and <code>const</code> are the modern ways to
            declare variables.
          </li>
          <li>
...
`}
        ...
        <p>
          JavaScript supports arithmetic operators (<code>+</code>,{" "}
          <code>-</code>, <code>*</code>, <code>/</code>), comparison operators
          (<code>==</code>, <code>!=</code>, <code>&gt;</code>,{" "}
          <code>&lt;</code>), and logical operators (<code>&amp;&amp;</code>,{" "}
          <code>||</code>, <code>!</code>).
        </p>
        <p>Example:</p>
        <CodeHighlight
...
`}
        ...
        />
        <p>
          <strong>Events</strong> allow you to respond to user actions like
...
`}
        ...
        <p>
          ...
          blocking the rest of the code. This will be covered heavily in a
          future module as this is one of the most important yet hardest
          concepts to grasp for new developers.
        </p>
        <p>
...
`}
        ...
        <h2>Summary</h2>
        <p>
          This introductory course gives you a foundation in JavaScript,
          covering variables, functions, the DOM, and asynchronous programming.
          From here, you can explore advanced topics like working with APIs,
          using JavaScript frameworks, and building full-fledged web
          applications.
        </p>
        {/* <NavigationLinks
        prevLesson={{
