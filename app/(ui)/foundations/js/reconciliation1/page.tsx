  ...
  return (
    <div className="flex max-w-[70ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        ...
        However, we can implement a basic version of reconciliation ourselves to
        understand how it works under the hood. This involves managing changes
        to the DOM in a more efficient way, rather than directly manipulating
        the DOM every time something changes.
      </p>
      <h2>
      ...
      <p>
        DOM reconciliation refers to the process of efficiently updating the DOM
        when there are changes in the data or state of an application. Instead
        of re-rendering the entire DOM tree when something changes,
        reconciliation involves:
      </p>
      <ul>
        <li>
          Creating a lightweight representation of the UI (similar to a Virtual
          DOM).
        </li>
      ...
      <h2>
        4.{" "}
        <strong>Implementing a Simple Virtual DOM in Vanilla JavaScript</strong>
      </h2>
      <p>
...
`}
      />
      <p>
        This <code>vDOM</code> object is a simple JavaScript object representing
...
`}
      ...
      <ol>
        ...
        <li>
          <strong>Diff and Patch</strong>: Compare old and new Virtual DOMs and
      ...
      <ul>
        <li>
          <strong>Virtual DOM</strong> helps create a lightweight representation
        ...
        <li>
          <strong>Patching</strong> applies the minimal changes to the real DOM,
          improving performance.
        </li>
      </ul>
      <p>
        This is the foundation of how frameworks like React achieve fast,
        efficient updates. But understanding the concept with vanilla JavaScript
        gives insight into what&#39;s happening behind the scenes.
      </p>
    </div>
  );
}
