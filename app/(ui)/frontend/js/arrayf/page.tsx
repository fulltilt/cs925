...
export default function ArrayF() {
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        JavaScript provides several powerful methods to work with arrays, making
        it easier to process, transform, and reduce data. Among these methods,{" "}
        <strong>
          <code>map()</code>
        </strong>
        ,{" "}
        ...
        are some of the most frequently used. In this tutorial, we will explore
        each of these methods, how they work, and provide practical examples to
        help you understand how to use them effectively.
      </p>
      <hr />
      ...
      <p>
        ...
        to perform complex transformations on arrays with concise and expressive
      ...
      <ul>
        <li>
          ...
          : Transforms each element in an array and returns a new array with the
          same length.
        </li>
        <li>
          <strong>
        ...
        <li>
          ...
          : Reduces an array to a single value by iteratively combining elements
      ...
      <p>
        ...
        element of the original array. It is ideal for scenarios where you want
        to <strong>transform</strong> data.
      </p>
      <h3>Syntax:</h3>
      <CodeHighlight
        content={`
...
`}
      ...
      <ul>
        <li>
          ...
          <code>numbers</code> array and returns a new array where each element
          is squared.
        </li>
        <li>
...
`}
      ...
      <ul>
        <li>
          ...
          those that pass the condition <code>num % 2 === 0</code>, which checks
          if a number is even.
        </li>
...
`}
      ...
      <p>
        ...
        <strong>square</strong> each number, <strong>filter out</strong> the odd
        numbers, and <strong>sum</strong> the remaining values:
      </p>
      <CodeHighlight
        content={`
const numbers = [1, 2, 3, 4, 5];
