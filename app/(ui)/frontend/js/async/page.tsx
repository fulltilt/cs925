  ...
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        ...
        often need to perform multiple operations simultaneously, like fetching
        data from a server, handling user interactions, or loading images. This
        is where <strong>asynchronous JavaScript</strong> comes into play.
      </p>
      <p>
        ...
        operations. In this tutorial, you will learn the basics of asynchronous
        JavaScript, including <strong>callbacks</strong>,{" "}
      ...
      <ul>
        <li>
          ...
          the other. If a task takes a long time, it blocks the following tasks
          from executing.
        </li>
        <li>
      ...
      <h2>1. Callbacks</h2>
      <p>
        A <strong>callback</strong> is a function that is passed as an argument
        to another function and is executed after some operation has completed.
      </p>
...
`}
      ...
      <p>
        ...
        <code>fetch</code> and <code>async/await</code>. It handles errors using{" "}
        <code>try...catch</code>.
      </p>
      <hr />
      <h2>
      ...
      <p>
        Let’s create a simple web page that displays a list of posts from an API
...
`}
      ...
      <ul>
        ...
        <li>
          <strong>Async/Await</strong>: A modern way to write asynchronous code,
      ...
      <p>
        ...
        responsive and efficient web applications. With practice, you’ll become
        more comfortable using these concepts to handle complex asynchronous
        operations.
      </p>
    </div>
  );
