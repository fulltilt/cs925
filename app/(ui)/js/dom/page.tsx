      ...
      <div className="flex flex-col sm:flex-row justify-center h-full">
        ...
        >
          ...
          <p>
            ...
            <strong>Document Object Model (DOM)</strong> represents the
            structure of an HTML document as a tree of nodes, and JavaScript
            gives you the power to interact with and modify these nodes. In this
            tutorial, we’ll explore how to use JavaScript to manipulate the DOM,
            covering methods for selecting, adding, modifying, and removing
            elements.
          </p>
          <hr />
          ...
          <p>
            ...
            programs can change the document structure, style, and content. When
            a web page is loaded, the browser creates a DOM for it, forming a
            tree structure of nodes where each element, attribute, and piece of
            text is a node.
          </p>
          <p>
...
`}
          ...
          <p>
            Use the <code>textContent</code> property to change the text inside
            an element:
          </p>
          <CodeHighlight
            content={`
...
`}
          ...
          <p>
            You can create new elements and add them to the DOM using methods
            like <code>createElement()</code> and <code>appendChild()</code>.
          </p>
          <h3>
...
`,
        ...
        <hr /> */}
          ...
          <ul>
            ...
            <li>
              <strong>Modify</strong> content, attributes, and styles of
              elements.
            </li>
            <li>
          ...
          <p>
            With these tools, you can create dynamic, responsive, and engaging
            web pages. Mastering DOM manipulation is an essential step in your
            journey as a front-end developer. You should have enough information
            to try the TODO exercise to cement what was covered in this lesson.
          </p>
        </div>
        <AnimatePresence>
          {showEditor && (
