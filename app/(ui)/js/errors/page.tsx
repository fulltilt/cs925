  ...
  return (
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          In this tutorial, we&#39;ll explore various error-handling techniques
          in JavaScript, including using <code>try...catch</code>, custom error
        ...
        <ul>
          ...
          <li>
            It allows you to provide <strong>graceful user feedback</strong>,
            such as showing an error message instead of a blank screen.
          </li>
          <li>
        ...
        <p>
          Before diving into handling errors, let&#39;s briefly review the
          common types of errors you may encounter in JavaScript:
        </p>
        <ul>
          <li>
            <strong>SyntaxError</strong>: Incorrect syntax in code (e.g.,
            missing a closing parenthesis).
          </li>
          <li>
            <strong>ReferenceError</strong>: Accessing a variable that
            hasn&#39;t been declared.
          </li>
          <li>
            <strong>TypeError</strong>: Performing an invalid operation on a
            data type (e.g., calling a method on <code>undefined</code>).
          </li>
          <li>
...
`}
        ...
        <ul>
          <li>
            If <code>userInput</code> is undefined, a{" "}
...
`}
        ...
        <p>
          ...
          the <code>throw</code> statement. This is useful when you want to
          create specific error conditions or validate inputs.
        </p>
...
`}
        ...
        <ul>
          ...
          <li>
            The <code>try...catch</code> block catches the error and displays
            the message <code>&quot;Cannot divide by zero.&quot;</code>.
          </li>
        </ul>
...
`}
        ...
        />
        <p>
          This allows you to distinguish between different types of custom
          errors using their <code>name</code> property.
        </p>
        <hr />
        <h2>5. Handling Asynchronous Errors</h2>
        <p>
          Asynchronous operations, such as network requests or file reading, can
          also produce errors. JavaScript provides different ways to handle
          these errors depending on whether you&#39;re using{" "}
          <strong>callbacks</strong>, <strong>Promises</strong>, or{" "}
...
`}
        ...
        />
        <p>
          In this example, the <code>finally</code> block will execute whether
          or not an error is caught, making it a good place for cleanup
          operations like closing a database connection.
        </p>
        <hr />
        ...
        <ul>
          <li>
            ...
            : Avoid wrapping every line of code in <code>try...catch</code> as
          ...
          <li>
            ...
            <code>instanceof</code> to catch specific error types when
            necessary.
          </li>
          <li>
        ...
        <h2>8. Conclusion</h2>
        <p>
          In this tutorial, you learned how to handle errors in JavaScript
          using:
        </p>
        <ul>
          <li>
        ...
        <p>
          By mastering error handling, you can create more resilient
          applications and improve the user experience. Remember to handle those
          errors gracefully!
        </p>
      </div>
    </ModuleWrapper>
