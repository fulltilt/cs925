  ...
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        ...
        to HTML elements. Event listeners specify what function should run when
        a particular event occurs on an element.
      </p>
...
`}
      ...
      />
      <p>
        However, this approach is generally not recommended for larger projects
        because it mixes JavaScript with HTML and can become difficult to
        maintain.
      </p>
      <h3>
...
`}
      ...
      <ul>
        ...
        <li>
          We add a <code>click</code> event listener to the button that triggers
          an <code>alert</code> when clicked.
        </li>
      </ul>
      <hr />
      ...
      <ul>
        ...
        <li>
          <strong>Form Events</strong>: <code>submit</code>, <code>change</code>
          , <code>input</code>, <code>focus</code>, <code>blur</code>
        </li>
        <li>
      ...
      <p>
        When an event occurs, the <strong>event object</strong> is automatically
        passed to the event handler function. This object contains useful
        information about the event, such as which key was pressed or which
...
`}
      ...
      <p>
        Event propagation determines how events flow through the DOM. There are
        two phases:
      </p>
      <ul>
        <li>
          <strong>Capturing</strong>: The event travels from the root of the DOM
      ...
      <p>
        By default, event listeners are set to <strong>bubble</strong>, but you
        can set the <code>useCapture</code> parameter to <code>true</code> to
        listen during the capturing phase.
      </p>
...
`}
        sandboxOption={false}
      />
      <p>This logs a message to the console whenever the button is clicked.</p>
...
`}
        sandboxOption={false}
      />
      <p>This prevents the form from submitting and logs a message instead.</p>
      <hr />
      <h2>Summary</h2>
      ...
      <ul>
        ...
        <li>
          <strong>Event Object</strong>: Accessing information about the event.
        </li>
        <li>
