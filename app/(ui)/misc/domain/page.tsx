  ...
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        ...
        you. There are many domain name registrars suchs as Squarespace, GoDaddy
        or AWS but for this tutorial we will go through how to register a domain
        on Cloudflare. <strong>Cloudflare</strong> is a popular service for
        domain registration, DNS management, and enhancing website performance
        through CDN (Content Delivery Network) and security services. In this
        tutorial, we&#39;ll go over the steps to{" "}
      ...
      <ul>
        <li>
          <strong>Cloudflare Account</strong>: If you don&#39;t have an account,
          create one at{" "}
      ...
      <ol>
        ...
        <li>
          Click on <strong>Registrar</strong> in the top navigation bar or find
          it in the menu on the left.
        </li>
      </ol>
      ...
      <ol>
        <li>
          If your domain is available, you will see a list of available domains
          and their prices.
        </li>
        <li>
      ...
      <p>
        Cloudflare will automatically set up your domain using Cloudflare&#39;s{" "}
        <strong>DNS</strong>.
      </p>
      <hr />
      ...
      <ul>
        ...
        <li>
          <strong>CNAME Record</strong>: Redirects one domain to another domain.
        </li>
        <li>
      ...
      <p>
        ...
        <code>123.123.123.123</code>, you would add an <strong>A Record</strong>{" "}
        like this:
      </p>
      <ul>
        <li>
      ...
      <ol>
        ...
        <li>
          ...
          <ul>
            <li>
              <strong>Flexible</strong>: Encrypts traffic between Cloudflare and
              visitors but not between Cloudflare and your server.
            </li>
            <li>
            ...
            <li>
              ...
              Cloudflare and your server, and your server must have a valid SSL
              certificate.
            </li>
          </ul>
        </li>
      ...
      <p>
        For the best security, use <strong>Full (strict)</strong> if your server
      ...
      <ol>
        <li>
          <strong>Wait for DNS Propagation</strong>: It might take a few minutes
          to a few hours for DNS changes to propagate across the internet.
        </li>
        <li>
        ...
        <li>
          Use tools like{" "}
          <a href="https://dnschecker.org">https://dnschecker.org</a> to verify
          that your DNS records have propagated.
        </li>
      </ol>
      <hr />
      <h2>6. Conclusion</h2>
