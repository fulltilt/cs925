    ...
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          ...
          helps developers track changes in their code, collaborate with others,
          and manage different versions of their projects. It&#39;s an essential
          tool for software development and widely used in both individual and
          team projects.
        </p>
        <hr />
        <h2>What is Git?</h2>
        <p>
          ...
          revert back to previous versions, and keeps a complete history of
          every change ever made. Git can be used for various types of projects,
        ...
        <ul>
          <li>
            <strong>Track Changes</strong>: Git records every change made to
            your codebase, making it easy to view, compare, and restore
            different versions of your project.
          </li>
          <li>
            <strong>Collaboration</strong>: With Git, multiple developers can
            work on the same project simultaneously without overwriting each
            other&#39;s work. Git merges changes from different contributors.
          </li>
          <li>
            <strong>Branching</strong>: Allows you to create separate
            environments for developing new features or fixing bugs without
        ...
        <ul>
          <li>
            A <strong>commit</strong> is a snapshot of your project&#39;s files
        ...
        <ul>
          ...
          <li>
            Git helps manage conflicts that may arise when merging changes.
          </li>
        </ul>
        <hr />
...
`}
        ...
        <p>
          To start a new Git repository, navigate to your project&#39;s folder
...
`}
        ...
        <ul>
          <li>
            Shows the status of changes in the working directory and staging
            area.
          </li>
          <li>
            Example:
...
`}
        ...
        <ul>
          <li>
            To merge changes from <code>new-feature</code> into{" "}
            <code>main</code>:
            <CodeHighlight
              content={`
git checkout main
...
`}
        ...
        <ul>
          <li>
            A <strong>pull request</strong> is a request to merge changes from
        ...
        <ul>
          <li>
            <strong>Commit Often</strong>: Make small, frequent commits with
            clear messages.
          </li>
          <li>
