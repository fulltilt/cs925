  ...
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        ...
        method works, its use cases, and why it is critical for modern security.
      </p>
      <hr />
      <h2>What is Public-Private Key Encryption?</h2>
      <p>
        Public-Private Key Encryption, also known as{" "}
        <strong>asymmetric encryption</strong>, is an encryption technique that
      ...
      <ul>
        ...
        <li>
          <strong>Private Key</strong>: Must be kept secret by the owner. It is
          used to decrypt data that was encrypted with the corresponding public
          key.
        </li>
      </ul>
      <p>
        This two-key mechanism enables secure communication, even if the public
        key is known to others, as only the holder of the corresponding private
      ...
      <ol>
        <li>
          <strong>Data Encryption</strong>: The sender encrypts a message using
          the recipient&#39;s <strong>public key</strong>.
        </li>
        <li>
          <strong>Secure Transmission</strong>: The encrypted data is sent over
          the network.
        </li>
      </ol>
      ...
      <ol>
        <li>
          <strong>Data Decryption</strong>: The recipient decrypts the received
          data using their <strong>private key</strong>.
        </li>
        <li>
          <strong>Access to Plaintext</strong>: Only the person with the private
          key can read the original message, even if the encrypted message was
      ...
      <Table>
        ...
        <tbody>
          <TableRow>
            ...
            <TableCell>Single key for both encryption and decryption</TableCell>
      ...
      <p>
        ...
        encryption in real-world scenarios, where asymmetric encryption is used
        to exchange keys securely, and symmetric encryption is used for faster
        data encryption.
      </p>
      <hr />
      ...
      <ul>
        ...
        <li>
          This guarantees both the authenticity of the sender and the integrity
          of the message.
        </li>
      </ul>
      <h3>Secure Email</h3>
...
`}
      ...
      <ul>
        <li>
          ...
          secure environments like hardware security modules (HSMs) or encrypted
          key vaults.
        </li>
        <li>
        ...
        <li>
          <strong>Backup Keys</strong>: Securely back up private keys to prevent
          data loss.
        </li>
      </ul>
      <hr />
      <h2>Conclusion</h2>
      <p>
        Public-private key encryption is a fundamental technology that underpins
        the security of online communications, ensuring confidentiality,
        integrity, and authenticity. Understanding how it works allows you to
        implement secure data transmission in your applications and ensure that
        sensitive information is protected. While asymmetric encryption is more
        complex than symmetric encryption, its ability to securely exchange
        information over open networks makes it an essential tool for modern
        security practices.
      </p>
    </div>
  );
