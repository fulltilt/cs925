...
export default function Regex() {
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        <strong>Regular Expressions</strong> (regex or regexp) are sequences of
        characters that define a search pattern. They are widely used in
      ...
      <p>
        A <strong>regular expression</strong> is a pattern that specifies a set
        of strings. These patterns are used for matching and searching text,
        replacing text, and performing complex string operations. Regular
        expressions are supported in many programming languages, including
      ...
      <ul>
        ...
        <li>
          <strong>Search and Replace</strong>: Find specific patterns in strings
          and replace them.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Matches: &quot;cat&quot; as a whole word, but not in &quot;cats&quot;.
        </li>
      </ul>
      <hr />
      ...
      <p>
        Checks if a pattern exists in a string and returns <code>true</code> or{" "}
        <code>false</code>.
      </p>
      <CodeHighlight
        content={`
...
`}
      ...
      <ul>
        ...
        <li>
          <strong>Keep Patterns Readable</strong>: Use whitespace, comments, and
          grouping to make complex patterns easier to read.
        </li>
        <li>
      ...
      <p>
        ...
        way. While the syntax can seem complex at first, understanding the basic
        components like character classes, quantifiers, and anchors will help
        you tackle most regex challenges. With practice, you&#39;ll be able to
        write more advanced patterns and use regular expressions to simplify
        your coding tasks.
      </p>
    </div>
  );
