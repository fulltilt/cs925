...
export default function TypeScript() {
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        <strong>TypeScript</strong> is a <strong>superset of JavaScript</strong>{" "}
        that adds <strong>static typing</strong> to the language. Developed by
        Microsoft, TypeScript aims to enhance JavaScript by enabling developers
        to catch potential errors during development, making large-scale
        applications easier to maintain. It compiles down to plain JavaScript,
        which means it can run anywhere JavaScript runs.
      </p>
      <p>
        When you are first starting off with TypeScript, it will be rough in the
        beginning (it still can get tricky even for experienced coders) but in
        the long run it will make your life easier although the benefits are
        obviously apparent.
      </p>
      <hr />
      ...
      <p>
        ...
        variables can hold. This enables you to define the structure of data and
        make sure that your code adheres to that structure. It provides tools
        like:
      </p>
      <ul>
        <li>
        ...
        <li>
          <strong>Compile-Time Error Checking</strong>: Catch errors before they
          even run, making development more predictable.
        </li>
      </ul>
      <hr />
...
`}
      ...
      <ul>
        <li>
          TypeScript makes code easier to understand by explicitly stating what
          types functions expect and what they return.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          The tooling is one of the biggest advantages, as TypeScript helps you
...
`}
      ...
      <p>
        <em>
          (NOTE: development frameworks such as Vite and NextJS can set this up
          for you automatically so you usually never have to worry about
...
`}
      ...
      <p>
        ...
        <strong>tsconfig.json</strong> file to configure how TypeScript compiles
        your code:
      </p>
      <CodeHighlight
        content={`
...
`}
      ...
      <p>
        ...
        where you can customize options like the target JavaScript version, file
        paths, and more.
      </p>
      <hr />
      <h2>Basic TypeScript Features</h2>
      <p>
        TypeScript builds upon JavaScript&#39;s syntax, making it easy to start
        writing TypeScript if you&#39;re familiar with JavaScript. Here&apos;s a
...
`}
      ...
      <h3>b. Interfaces</h3>
      <p>
        Interfaces allow you to define the structure of an object. This makes it
        easy to ensure that an object has the correct shape:
      </p>
      <CodeHighlight
        content={`
interface User {
...
`}
      ...
      <p>
        TypeScript is designed to be <strong>adopted gradually</strong>. You can
        start by renaming <code>.js</code> files to <code>.ts</code> and
      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell>Dynamic typing (types are checked at runtime)</TableCell>
            <TableCell>
      ...
      <p>
        ...
        <strong>error-free</strong> JavaScript applications. It is particularly
        valuable in large codebases or teams where catching errors early,
        consistent data structures, and better developer tooling can save time
        and reduce bugs.{" "}
      </p>
      <p>Key reasons to consider using TypeScript:</p>
      <ul>
        <li>
          It catches errors early through <strong>static type checking</strong>.
        </li>
        <li>It provides better tooling, making development more efficient.</li>
        <li>
          It ensures <strong>type safety</strong> and enhances{" "}
          <strong>code readability</strong>.
        </li>
        <li>
          It allows you to <strong>gradually adopt</strong> its features without
          needing to rewrite your entire JavaScript codebase.
        </li>
      </ul>
      <p>
        By adopting TypeScript, you&apos;ll not only improve the reliability of
        your code but also enhance your development experience, leading to a
        more robust and scalable project.
      </p>
    </div>
  );
}
