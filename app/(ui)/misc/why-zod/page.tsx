    ...
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          ...
          validation library. It&apos;s used for defining and validating
          objects, arrays, and other data types in a concise and readable way.
          Unlike other validation libraries, Zod uses{" "}
        ...
        <p>
          Using <strong>Zod</strong> for validation offers several advantages
          over writing custom validation logic yourself. These benefits include{" "}
        ...
        <p>
          Imagine you want to validate a user object with the following
          structure:
        </p>
        <ul>
          <li>
...
`}
        ...
        <ul>
          <li>
            Zod provides a <strong>one-liner</strong> to define each rule,
            making it <strong>more concise</strong>.
          </li>
          <li>
...
`}
        ...
        <ul>
          ...
          <li>
            <strong>Partial Validation</strong>: Zod&#39;s{" "}
            <code>.partial()</code> method allows creating a version of the
            schema where all fields are optional, useful for updates.
          </li>
        </ul>
        <p>
          <strong>Manual Validation</strong>:
        ...
        <p>
          ...
          <strong>static types</strong> based on your schemas. This allows you
          to keep your validation logic and TypeScript types in sync, reducing
          bugs caused by mismatched types.
        </p>
...
`}
        ...
        <ul>
          <li>
            ...
            <code>z.infer&lt;typeof userSchema&gt;</code> automatically
            generates a <code>User</code> type from the schema.
          </li>
          <li>
            <strong>Type Safety</strong>: The <code>createUser</code> function
            is typed correctly, and TypeScript will show errors if you pass
            incorrect data.
          </li>
        </ul>
        <p>
        ...
        <p>
          When writing custom validation, you have to maintain separate
          TypeScript types and validation logic, which can easily become{" "}
...
`}
        ...
        <ul>
          <li>
            <strong>Redundancy</strong>: You have to define the{" "}
            <code>User</code> type and then manually ensure that your validation
            logic matches it.
          </li>
          <li>
...
`}
        ...
        <ul>
          ...
          <li>
            <strong>Custom Error Messages</strong>: You can easily customize
            error messages with methods like <code>.min()</code> or{" "}
            <code>.email()</code>.
          </li>
        </ul>
        <p>
        ...
        <p>
          With custom validation logic, generating similar detailed error
          messages requires additional code:
        </p>
        <CodeHighlight
          content={`
function validateUser(data) {
...
`}
        ...
        <ul>
          <li>
            <strong>Manual Error Handling</strong>: You need to manually build
            the error structure.
          </li>
          <li>
            <strong>Extra Boilerplate</strong>: The custom validation code
            becomes longer and harder to maintain.
          </li>
        </ul>
        <hr />
        <h2>Extensibility and Built-In Features</h2>
        <p>
          Zod comes with many built-in methods for validation and
          transformation, which saves time and reduces the likelihood of bugs.
        </p>
...
`}
        ...
        <ul>
          ...
          <li>
            Offers <strong>reusability</strong> and{" "}
            <strong>extensibility</strong> with built-in validation methods.
          </li>
        </ul>
        <p>
          These features make Zod a great choice for developers who want to
          ensure the data they are ingesting is valid which is a very common
          source of bugs.
        </p>
      </div>
    </ModuleWrapper>
