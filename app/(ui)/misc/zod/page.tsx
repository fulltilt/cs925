  ...
  return (
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        <h1>Zod Schema Validation in JavaScript and TypeScript</h1>
        <p>
...
`}
        ...
        <p>
          <em>
            ...
            credo. Basically what that means is, validation is important but
            with parsing, you not only get validation but you also can transform
            the data into a more appropriate shape for your uses.)
          </em>
        </p>
...
`}
        ...
        <ul>
          ...
          <li>
            <code>safeParse()</code>: Returns an object with{" "}
            <code>success</code> and <code>error</code> fields, allowing you to
...
`}
        ...
        <ul>
          ...
          <li>
            If the data is invalid, <code>result.error</code> will contain
            details about why the validation failed.
          </li>
        </ul>
        <hr />
...
`}
        ...
        <p>
          Zod allows you to <strong>transform</strong> data after validation
          using <code>.transform()</code>.
        </p>
...
`}
        ...
        />
        <p>
          You can customize error messages for individual validations to make
...
`}
        ...
        <h2>Conclusion</h2>
        <p>
          Zod provides a powerful yet simple way to <strong>validate</strong>{" "}
          and <strong>transform</strong> data in both JavaScript and TypeScript
          projects. It enables you to define schemas that ensure your data
          conforms to the expected shape and provides detailed error messages
        ...
        <p>
          ...
          when working with APIs or complex data structures.
        </p>
      </div>
    </ModuleWrapper>
  );
