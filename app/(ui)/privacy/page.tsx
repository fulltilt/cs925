export default function Privacy() {
  return (
    <div className="flex max-w-[70ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        This Privacy Notice for OpenMat ("<b>we</b>," "<b>us</b>," or "
        <b>our</b>"), describes how and why we might access, collect, store,
      ...
      <h2 className="mt-8 text-xl font-bold">SUMMARY OF KEY POINTS</h2>
      <p className="font-semibold">
        <em>
          This summary provides key points from our Privacy Notice, but you can
          find out more details about any of these topics by clicking the link
          following each key point or by using our{" "}
          <a href="#toc" className="text-blue-700">
            table of contents
          </a>{" "}
      ...
      <p>
        ...
        how you interact with us and the Services, the choices yof make, and the
        products and features you use. Learn more about{" "}
        <a href="#pti" className="text-blue-700">
      ...
      <p>
        ...
        for security and traud prevention, and to comply with law. We may also
        process your information for other purposes with your consent. We
        process your information only when we have a valid legal reason to do
        so. Learn more about{" "}
        <a href="#process" className="text-blue-700">
      ...
      <p>
        ...
        <a href="#rights" className="text-blue-700">
          your privacy rights
        </a>
        .
      </p>
      ...
      <h2 className="mt-12 text-xl font-bold" id="toc">
        TABLE OF CONTENTS
      </h2>
      <ol className="list-decimal">
        ...
        <li>
          <a href="#cookies" className="text-blue-700">
            DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?
          </a>
        </li>
        <li>
          <a href="#social" className="text-blue-700">
            HOW DO WE HANDLE YOUR SOCIAL LOGINS?
          </a>
        </li>
        <li>
          <a href="#long" className="text-blue-700">
        ...
        <li>
          <a href="#controls" className="text-blue-700">
            CONTROLS FOR DO-NOT-TRACK FEATURES
          </a>
        </li>
        <li>
          <a href="#us" className="text-blue-700">
            DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
          </a>
        </li>
        <li>
          <a href="#updates" className="text-blue-700">
        ...
        <li>
          <a href="#review" className="text-blue-700">
            HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?
          </a>
        </li>
      </ol>
      <h2 className="mt-8 text-xl font-bold" id="collect">
        1. WHAT INFORMATION DO WE COLLECT?
      </h2>
      <h3 className="text-l font-bold" id="pti">
        Personal information you disclose to us
      </h3>
      <p>
        <em>
      ...
      <h2 className="mt-8 text-xl font-bold" id="process">
      ...
      <p>
        <em>
          ...
          fulfill our contractual obligations, to protect your nights, or to
      ...
      <ul className="ml-12 list-disc space-y-2">
        <li>
          ...
          more about{" "}
          <a href="#consent" className="text-blue-700">
      ...
      <h2 className="mt-8 text-xl font-bold" id="share">
      ...
      <h2 className="mt-8 text-xl font-bold" id="cookies">
      ...
      <p>
        ...
        including to help manage and display advertisements, to tallor
      ...
      <p>
        ...
        the{" "}
        <a className="text-blue-700" href="https://policies.google.com/privacy">
          Google Privacy & Terms page
        </a>
        .
      </p>
      <h2 className="mt-8 text-xl font-bold" id="social">
      ...
      <p>
        ...
        information abdut you from your social media provider. The profile
      ...
      <h2 className="mt-8 text-xl font-bold" id="long">
      ...
      <h2 className="mt-8 text-xl font-bold" id="rights">
      ...
      <p>
        ...
        information, (1) to request rectification or erasure: (li) to restrict
      ...
      <p>
        <b id="consent" className="underline">
          Withdrawing your consent
        </b>
      ...
      <h2 className="mt-8 text-xl font-bold" id="controls">
      ...
      <h2 className="mt-8 text-xl font-bold" id="us">
        11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
      </h2>
      <p>
        <em>
          <b>In Short</b>: If you are a resident of California, Colorado,
          Connecticut, Delaware, Florida, Indiana, lowa, Kentucky, Montana, New
      ...
      <table className="border p-4">
        <thead>
          <tr>
            ...
            <th className="border p-4">Examples</th>
            <th className="border p-4">Collected</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td className="border p-4">
              ...
              online identifier, IP address, email
            </td>
          ...
          <tr>
            ...
            <td className="border p-4">
              Business contact details to provide Services at a business level
          ...
          <tr>
            <td className="border p-4">J. Education Information</td>
            <td className="border p-4">
          ...
          <tr>
            ...
            <td className="border p-4">
              ...
              listed above to create a profile or summary about an
              individual&apos;s preferences and characteristics
            </td>
            <td className="border p-4">YES</td>
          </tr>
          <tr>
            <td className="border p-4">L. Sensitive personal information</td>
            <td className="border p-4">N/A</td>
            <td className="border p-4">NO</td>
          </tr>
        </tbody>
      </table>
      ...
      <h3 className="font-semibold">How We Use and Share Personal</h3>
      <p>
        Information Learn about how we use your personal information in the
        section,{" "}
        <a className="text-blue-700" href="#process">
          "HOW DO WE PROCESS YOUR INFORMATION?"
        </a>
      </p>
      <p className="font-semibold">
      ...
      <p>
        ...
        Learn more about now we disclose personal information to in the section,
        <a className="text-blue-700" href="#share">
          "WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?"
        </a>
      </p>
      <p>
      ...
      <h3 className="font-semibold"> How to Exercise Your Rights</h3>
      <p>
      ...
      <p>
        ...
        for the purposes of verifying your identity and for security or fraud
        prevention purposes.
      </p>
      <p>
      ...
      <h3 className="font-semibold">California "Shine The Light" Law </h3>
      <p>
      ...
      <h2 className="mt-8 text-xl font-bold" id="updates">
      ...
      <h2 className="mt-8 text-xl font-bold" id="contact">
      ...
      <h2 className="mt-8 text-xl font-bold" id="review">
