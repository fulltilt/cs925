  ...
  return (
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        <h1>Handling Form Data in React</h1>
        <p>
          ...
          <strong>FormData</strong> object for managing form submissions in a
          more dynamic way.
        </p>
        <hr />
        ...
        <ul>
          ...
          <li>
            <strong>Uncontrolled Components</strong>: The form data is handled
            by the DOM itself. React uses <strong>refs</strong> to access the
            input values when needed.
          </li>
        </ul>
        <hr />
        ...
        <p>
          ...
          form values and allows for advanced features like validation as the
          user types.
        </p>
...
`}
        ...
        <ul>
          ...
          <li>
            The <code>onChange</code> event handler updates the state whenever
            the user types, ensuring the input&#39;s value reflects the state.
          </li>
          <li>
        ...
        <p>
          With uncontrolled components, the form data is stored in the DOM
          itself rather than in the component&#39;s state. We use{" "}
          <strong>refs</strong> to access the form values when needed.
        </p>
...
`}
        ...
        <ul>
          ...
          <li>
            ...
            the input values directly through <code>ref.current.value</code>{" "}
            when the form is submitted.
          </li>
          <li>
            The state is not updated on every change, which can be more
            performant for simple forms.
          </li>
        </ul>
        <p>
...
`}
        ...
        <ul>
          <li>
            The <code>FormData</code> object allows us to retrieve form values
            by iterating over the entries using <code>formData.entries()</code>.
          </li>
          <li>
        ...
        <h2>6. Conclusion</h2>
        <p>
          Handling form data in React requires understanding the different
          methods available, such as <strong>controlled components</strong>,{" "}
          ...
          FormData object can be particularly useful for handling form
          submissions dynamically.
        </p>
        <p>
          By choosing the right approach, you can ensure your forms are
