...
`}
        ...
        <ul>
          <li>
            The <code>state</code> is initialized in the{" "}
        ...
        <ul>
          <li>
            <code>componentDidMount()</code>: Runs after the component is added
            to the DOM.
          </li>
          <li>
            <code>componentDidUpdate()</code>: Runs after state or props
            changes.
          </li>
          <li>
...
`}
        ...
        <ul>
          ...
          <li>
            The state is updated using <code>setState</code> when data is
            fetched or when an error occurs.
          </li>
          <li>
...
`}
        ...
        <ul>
          <li>
            ...
            constructor to ensure that <code>this</code> inside the method
        ...
        <p>
          Alternatively, you can use an <strong>arrow function</strong> for
          class methods, which auto-binds <code>this</code>:
        </p>
        <CodeHighlight
          content={`
class ClickHandler extends Component {
...
`}
        ...
        <p>
          Handling forms was also commonly done with class components using
          state.
        </p>
...
`}
        ...
        <ul>
          <li>
            <code>handleChange</code> updates the state when the user types in
            the input field.
          </li>
          <li>
            The <code>inputValue</code> state is used as the <code>value</code>{" "}
            of the input, making it a <strong>controlled component</strong>.
          </li>
          <li>
        ...
        <p>
          ...
          modern React, <strong>functional components with hooks</strong> are
          now the preferred approach due to their simplicity and flexibility.
          Understanding class components is useful for maintaining older
          codebases or working in environments where hooks may not yet be
          adopted.
        </p>
      </div>
    </ModuleWrapper>
