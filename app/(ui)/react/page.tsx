  ...
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <p>
        ...
        which makes building complex user interfaces simpler and more efficient.
      </p>
      <hr />
      <h2>What is React?</h2>
      <p>
      ...
      <ul>
        ...
        <li>
          <strong>Declarative</strong>: React makes it easy to build interactive
          UIs. You design simple views for each state in your application, and
          React updates and renders the right components as data changes.
        </li>
        <li>
      ...
      <p>
        To create a new React app, the two most popular ways are through NextJS
        or through Vite. Previously, you used
        <strong>Create React App (CRA)</strong>, but that has since been
        deprecated. Either Vite or NextJS are excellent options but for learning
        purposes, since these initial apps are relatively small, you can stick
        to Vite as it's more lightweight and is less opinionated.
      </p>
...
`}
        ...
        <li>
          For the options, enter any project name, select <strong>React</strong>{" "}
          for the framework and for the variant, select{" "}
      ...
      <p>
        ...
        work together to create the user interface. There are two main types of
        components:
      </p>
      <ul>
        <li>
...
`}
      ...
      <p>
        ...
        look like. It makes the code easier to read and write, as it allows you
        to combine JavaScript logic with UI structure.
      </p>
...
`}
      ...
      <p>
        <strong>State</strong> and <strong>Props</strong> are essential concepts
        in React, allowing you to create dynamic and reusable components.
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          managed within the component. State allows components to react to user
          inputs, form changes, or any other events.
        </li>
      </ul>
...
`}
      ...
      />
      <p>
        Here, <code>useState</code> is a <strong>hook</strong> that lets you add
        state to functional components. The <code>count</code> variable holds
        the state, and <code>setCount</code> updates it.
      </p>
      <p>
        <em>
          ...
          <Link href="/react/old">This module</Link> briefly goes over this and
          it's something to be aware of as you may encounter older cold out in
          the wild.
        </em>
      </p>
      <hr />
      ...
      <p>
        ...
        <strong>event handlers</strong>. Event handlers in React are similar to
        those in plain JavaScript but use <strong>camelCase</strong> and{" "}
...
`}
      ...
      />
      <p>
        In this example, the <code>handleClick</code> function is triggered when
        the button is clicked, showing an alert message.
      </p>
      <hr />
...
`}
      ...
      <ul>
        ...
        <li>
          The current count is displayed in an <code>&lt;h1&gt;</code> element.
        </li>
      </ul>
      <hr />
      <h2>Conclusion</h2>
      ...
      <p>
        ...
        <strong>state management</strong> libraries like <strong>Redux</strong>.
      </p>
    </div>
  );
}
