    ...
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          ...
          of as <strong>data</strong> that changes over time, usually as a
          result of user interactions, such as input changes, button clicks, or
          API responses.
        </p>
        <p>
          ...
          automatically <strong>re-renders</strong> that component to reflect
          the new state.
        </p>
        <hr />
        <h2>
        ...
        <p>
          ...
          <strong>functional components</strong>. It allows you to declare a
...
`}
        ...
        <ul>
          ...
          <li>
            Clicking the increment button increases the count, while clicking
            the decrement button decreases it.
          </li>
        </ul>
        <hr />
...
`}
        ...
        <p>
          When multiple components need to <strong>share</strong> the same
          state, you can <strong>lift state up</strong> to the nearest common
          ancestor.
        </p>
...
`}
        ...
        <ul>
          ...
          <li>
            <code>ChildComponent</code> receives <code>onChange</code> as a
            prop, allowing it to update the state in the parent.
          </li>
          <li>
...
`}
        ...
        <ul>
          ...
          <li>
            <code>ThemeSwitcher</code> uses <code>useContext</code> to access
            and change the <code>theme</code> without needing to pass props
            down.
          </li>
        </ul>
        <hr />
...
`}
        ...
        <h2>Conclusion</h2>
        <p>
          State management in React is crucial for building dynamic and
          responsive applications. This tutorial covered:
        </p>
        <ul>
          <li>
