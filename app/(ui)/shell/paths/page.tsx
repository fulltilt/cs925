  ...
  return (
    <ModuleWrapper>
      <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
        ...
        <p>
          In computing, a <strong>directory path</strong> is like an address
          that tells the operating system where a file or folder is located on a
          computer. Understanding how to navigate through directories is
          essential when working with command-line tools or managing files. This
          tutorial will guide you through the basics of directory paths, the
          difference between <strong>absolute</strong> and{" "}
          <strong>relative</strong> paths, and how to navigate using common
          command-line commands in <strong>Windows</strong>,{" "}
        ...
        <p>
          ...
          much like a postal address helps you find a location in the real
          world.
        </p>
        <h3>Types of Paths</h3>
        <p>
          <strong>Absolute Path</strong>: This specifies the complete location
          of a file or directory, starting from the root directory. It always
          begins with the root directory (like <code>/</code> in Unix-based
          systems or a drive letter like <code>C:</code> in Windows).
        </p>
        <ul className="ml-4">
          <li>
        ...
        <p>
          The command-line interface (CLI) allows you to navigate and manage
          files using text commands. Below are some common commands for{" "}
          <strong>Windows Command Prompt</strong>,{" "}
          <strong>macOS Terminal</strong>, and <strong>Linux Terminal</strong>.
        </p>
        <h3>
...
`}
        ...
        <p>
          To see what files and directories are inside the current directory:
        </p>
        <strong>Windows:</strong>
        <CodeHighlight
          content={`
...
`}
        ...
        <h2>Summary</h2>
        <p>
          Navigating directories using the command-line is a fundamental skill
          for working with files and folders efficiently. Understanding absolute
          and relative paths helps you move around the file system quickly and
          perform tasks like organizing files, creating projects, and setting up
          environments. Practice these commands, and you&#39;ll become
          comfortable with directory paths in no time!
        </p>
      </div>
    </ModuleWrapper>
  );
