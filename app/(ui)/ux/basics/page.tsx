  ...
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <ul>
        ...
        <li>
          🌱 Text Legibility: Ensure ample spacing, appropriate line length, and
        ...
        <li>
          🔄 Consistent Design: Maintain consistency in colors, typography, and
      ...
      <ul>
        ...
        <li>
          ✍️ Text as Visual Element: Treat text as a visual element by ensuring
          proper spacing, line height, and legibility to facilitate reading and
          comprehension.
        </li>
        <li>
        ...
        <li>
          ⚙️ Progressive Disclosure: Provide information progressively to avoid
          overwhelming users, guiding them through necessary steps in a logical
          manner.
        </li>
      </ul>
    </div>
