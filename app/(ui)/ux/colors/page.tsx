  ...
  return (
    <div className="flex flex-col sm:flex-row justify-center h-full">
      ...
      >
        <h1>Colors</h1>
        <p>
          Colors play a vital role in web design, influencing aesthetics, brand
          perception, and user experience. Using the right colors can make a
          website visually appealing and help communicate its message
          effectively. This tutorial will cover the basics of color theory,
          different types of color codes used in web design, tools for choosing
          colors, and practical tips for applying colors in web design.
        </p>
        <hr />
        ...
        <p>
          Color theory is a framework for understanding how colors interact. It
          helps designers create balanced and visually pleasing color palettes.
          Here are some key concepts:
        </p>
        <ul>
          <li>
            <strong>Color Wheel</strong>: A circular arrangement of colors that
            shows the relationship between primary (red, blue, yellow),
            secondary (green, orange, purple), and tertiary colors.
          </li>
          <li>
            <strong>Complementary Colors</strong>: Colors opposite each other on
            the color wheel (e.g., red and green). They create a high-contrast,
            vibrant look when used together.
          </li>
          <li>
            <strong>Analogous Colors</strong>: Colors next to each other on the
            color wheel (e.g., blue, blue-green, green). They create a
          ...
          <li>
            <strong>Monochromatic Colors</strong>: Different shades, tints, and
            tones of a single color. This approach provides a clean, elegant
            look.
          </li>
        </ul>
        <h2>Types of Color Codes</h2>
        <p>
          In web design, colors can be represented in different ways using CSS.
        ...
        <p>
          Hex codes use a combination of six characters (0-9, A-F) to represent
          colors. They are the most commonly used in web design.
        </p>
        <CodeHighlight
          content={`
...
`,
        ...
        <p>
          ...
          specifying the intensity of each color.
        </p>
        <CodeHighlight
          content={`
...
`,
        ...
        <p>
          RGBA is similar to RGB but includes an alpha channel, which specifies
...
`,
        ...
        <p>
          HSL stands for Hue, Saturation, and Lightness. It’s more intuitive for
          designers since it describes colors in terms of their tint and shade.
        </p>
        <CodeHighlight
          content={`
...
`,
        ...
        <p>
          There are several online tools that help you choose and generate color
          palettes for web design:
        </p>
        <ul>
          <li>
            <strong>Adobe Color</strong>: Allows you to create and explore color
          ...
          <li>
            <strong>Colorzilla</strong>: A browser extension that lets you pick
            colors from any website.
          </li>
          <li>
        ...
        <p>
          Colors can be applied to different parts of a web page using CSS. Here
...
`,
        ...
        <p>
          Set the color of borders using the <code>border-color</code> property.
        </p>
        <CodeHighlight
          content={`
div {
...
`,
        ...
        <p>
          ...
          shades and tints across different sections of the website to maintain
          consistency.
        </p>
        <h3>
        ...
        <p>
          ...
          different colors and see how they impact the mood and functionality of
          your design.
        </p>
      </div>
      <AnimatePresence>
