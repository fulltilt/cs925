    ...
    <ModuleWrapperClient>
      <div className="flex flex-col sm:flex-row justify-center h-full">
        ...
        >
          ...
          <p>
            <strong>Flexbox</strong> (or <strong>Flexible Box Layout</strong>)
            is a powerful layout model in CSS that allows you to design complex
...
`}
          ...
          <p>
            ...
            layout—<strong>you choose</strong> how items should be aligned
            within the flex container.
          </p>
          <ul>
            <li>
              <strong>Row</strong>: When you want the items to be aligned
              horizontally, you use <code>flex-direction: row</code> (which is
              the default). Think of this as aligning items{" "}
...
`}
          ...
          <ul>
            ...
            <li>
              <code>space-evenly</code>: Distributes items with equal space
              around them.
            </li>
          </ul>
          <CodeHighlight
...
`,
          ...
          <p>
            Flexbox makes aligning items along both the{" "}
            <strong>main axis</strong> and <strong>cross axis</strong>{" "}
            straightforward. This helps with creating layouts that respond well
...
`,
          ...
          <p>
            Defines how much space a flex item should take up relative to
            others:
          </p>
          <CodeHighlight
            content={`
...
`,
          ...
          <ul>
            ...
            <li>
              <code>flex: 1</code> and <code>flex: 3</code> determine the
              relative space each part takes up.
            </li>
          </ul>
          <h3>
...
`,
          ...
          <h2>Conclusion</h2>
          <p>
            Flexbox is a highly versatile layout system that allows you to
            easily manage complex layouts by thinking in terms of{" "}
