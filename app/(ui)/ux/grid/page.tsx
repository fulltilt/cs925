...
export default function Grid() {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-center h-full">
      ...
      >
        <h1>Grid Layout</h1>
        <h2>Tutorial: Understanding CSS Grid Layout</h2>
        <p>
          <strong>CSS Grid Layout</strong> is a powerful, two-dimensional layout
          system in CSS. It allows you to create complex layouts on the web more
          easily than with traditional methods like floats or Flexbox. Unlike
          Flexbox, which is one-dimensional (either rows or columns), CSS Grid
          allows you to manage both rows and columns simultaneously, making it
          ideal for creating grid-based designs like websites, dashboards, and
          galleries.
        </p>
        <hr />
        ...
        <p>
          ...
          <strong>columns</strong> and control the placement of elements within
          this structure. It provides a high level of control over both the
          dimensions and position of elements, making it easier to build
        ...
        <p>
          ...
          <strong>grid container</strong> by setting <code>display: grid</code>{" "}
          on an element.
        </p>
        <CodeHighlight
          content={`
...
`,
        ...
        <ul>
          ...
          <li>
            The <code>gap</code> property adds spacing between rows and columns.
          </li>
        </ul>
        <hr />
...
`,
        ...
        <p>
          ...
          fixed width while the other two columns grow relative to the remaining
          space.
        </p>
        <h3>
...
.item4 {
    background: lightgoldenrodyellow;
        ...
        <ul>
          ...
          <li>
            <code>grid-row: 1 / 2</code> means that the element spans from row 1
            to row 2.
          </li>
        </ul>
        <hr />
        ...
        <p>
          <code>grid-template-areas</code> allows you to create a visual map of
          your layout using named areas, making it easier to see how different
          parts of your design fit together.
        </p>
        <h3>
...
`,
        ...
        <p>
          CSS Grid can be combined with <strong>media queries</strong> to create
          layouts that adjust based on screen size, making it ideal for
          responsive design.
        </p>
...
`}
        ...
        <ul>
          ...
          <li>
            <code>repeat(3, 1fr)</code> creates three columns that each take up
...
`,
        ...
        <ul>
          <li>
            ...
            minimum width of <code>150px</code> and a maximum width that expands
            as needed.
          </li>
          <li>
