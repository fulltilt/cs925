...
export default function Images() {
  return (
    <div className="flex max-w-[75ch] mx-4 sm:mx-auto flex-col gap-4 empty:hidden first:pt-[3px] lesson">
      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li>Offers compression but may lose some image quality (lossy).</li>
          </ul>
        </li>
        <li>
          <p>
      ...
      <p>
        Optimizing images helps improve website speed and user experience. Here
        are some ways to optimize images:
      </p>
      <ul>
        <li>
          ...
          <a href="https://squoosh.app/">Squoosh</a> to reduce file size without
        ...
        <li>
          ...
          your needs (e.g., JPEG for photos, PNG for images with transparency).
        </li>
        <li>
...
`}
      ...
      <ul>
        ...
        <li>
          ...
          : <code>cover</code> scales the image to cover the entire area, while{" "}
          <code>contain</code> scales it to fit within the area.
        </li>
        <li>
          <strong>
...
`}
      ...
      <ul>
        <li>
          ...
          multiple image formats. The browser will choose the most suitable one.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>Maintain Consistency</strong>: Use images that align with your
          brand&#39;s visual style. This consistency helps reinforce your
          brand’s identity.
        </li>
        <li>
        ...
        <li>
          <strong>Think About Layout</strong>: Use images that fit the layout of
          your design. Cropped or poorly positioned images can disrupt the
      ...
      <p>
        ...
        can create beautiful and user-friendly websites. Always keep the balance
        between aesthetics and performance in mind, and use images to enhance
