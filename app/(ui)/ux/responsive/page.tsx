      ...
      <div className="flex flex-col sm:flex-row justify-center h-full">
        ...
        >
          ...
          <p>
            ...
            <strong>responsive images</strong>, and more.
          </p>
          <hr />
          <h2>What is Responsive Web Design?</h2>
          <p>
            Responsive Web Design is a design approach where a website is built
            to <strong>adapt</strong> to the user&#39;s screen size and device
          ...
          <ul>
            <li>
              <strong>Increased Mobile Traffic</strong>: More users are
              accessing websites on mobile devices than ever before. Responsive
              design ensures that your website looks good on any screen.
            </li>
            <li>
              <strong>Improved User Experience</strong>: Consistent navigation
              and content layout across devices help users interact more
              comfortably with your site.
            </li>
            <li>
          ...
          <p>
            ...
            proportionally, rather than relying on fixed widths. Instead of
            using fixed pixels (<code>px</code>),{" "}
            <strong>percentage-based units</strong> (<code>%</code>) are used
            for widths, allowing elements to scale relative to their parent
            container.
          </p>
...
`,
          ...
          <ul>
            ...
            <li>
              The <code>box-sizing: border-box</code> property ensures padding
              and borders are included in the element&#39;s width, preventing
              overflow.
            </li>
          </ul>
          <hr />
          <h2>Media Queries</h2>
          <p>
            <strong>Media queries</strong> allow you to apply CSS styles based
            on the properties of the user’s device, such as screen width,
            height, resolution, and orientation. They are fundamental to
...
`}
          ...
          <ul>
            <li>
              <strong>Mobile-First Approach</strong>: Start with styles
              optimized for small screens, then use <code>min-width</code> media
              queries to adjust styles for larger screens.
            </li>
            <li>
          ...
          <p>
            Images need to scale properly to maintain a responsive design. This
            is achieved using <strong>max-width</strong> and{" "}
            <strong>height</strong> properties.
          </p>
          <h3>
...
`}
          ...
          <ul>
            <li>
              <strong>Flexbox</strong> is great for aligning items along a
          ...
          <ul>
            <li>
              <strong>Use a Mobile-First Approach</strong>: Start with styles
              for the smallest screens and add styles for larger screens using
              media queries.
            </li>
            <li>
          ...
          <p>
            ...
            access websites from a wide range of devices. By using fluid
            layouts, media queries, and responsive images, you can create
            websites that adapt to any screen size.
          </p>
          <p>
            With tools like <strong>Flexbox</strong> and{" "}
            <strong>CSS Grid</strong>, you can further control the layout in a
            flexible way, making it easy to design layouts that adjust
            beautifully from mobile to desktop. This approach ensures that users
            have a smooth experience, no matter how they access your site.
          </p>
          <p>
